...
namespace CaseStudy.Migrations
{
    ...
    [Migration("20230421181935_Initial2")]
            ...
            modelBuilder.Entity("CaseStudy.Models.Incident", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            IncidentId = 1,
                            CustomerId = 5,
                            DateOpened = new DateTime(2023, 4, 21, 13, 19, 35, 110, DateTimeKind.Local).AddTicks(7835),
                        ...
                        new
                        {
                            IncidentId = 2,
                            CustomerId = 2,
                            DateOpened = new DateTime(2023, 4, 21, 13, 19, 35, 110, DateTimeKind.Local).AddTicks(7839),
                            Description = "Program fails with error code 510, unable to open database.",
                            ProductId = 7,
                            TechnicianId = 1,
                        ...
                        new
                        {
                            IncidentId = 3,
                            CustomerId = 3,
                            DateOpened = new DateTime(2023, 4, 21, 13, 19, 35, 110, DateTimeKind.Local).AddTicks(7842),
                            Description = "Program fails with error code 510, unable to open database.",
                            ProductId = 1,
                            TechnicianId = 3,
                            Title = "Error launching program"
                        ...
                        new
                        {
                            IncidentId = 4,
                            CustomerId = 5,
                            DateOpened = new DateTime(2023, 4, 21, 13, 19, 35, 110, DateTimeKind.Local).AddTicks(7845),
                            Description = "Program fails with error code 510, unable to open database.",
                            ProductId = 4,
                            TechnicianId = 2,
